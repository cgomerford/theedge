// src/app/mlb/batting-lab/[playerId]/layout.tsx
//
// SERVER layout: the Pro gate for every /mlb/batting-lab/[playerId]/* page. The
...
export default async function BattingLabGate({ children, params }: { children: React.ReactNode; params: Promise<{ playerId: string }> }) {
  const { playerId } = await params
  if (!(await isProViewer())) return <LabLocked lab="batting" playerId={Number(playerId) || 0} />
